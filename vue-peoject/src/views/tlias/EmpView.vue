                    ...
                    <el-menu :default-openeds="['1', '3']">
                        <el-submenu index="1">
                            ...
                            <el-menu-item index="1-1">
                                <router-link to="/depart">部门管理</router-link>
                            </el-menu-item>
                ...
                <el-main>
                    ...
                    <el-table :data="tableData" border>
                        ...
                        <el-table-column label="性别" width="140">
                            <template slot-scope="scope">
                                {{ scope.row.gender == 1 ? '男' : '女' }}<!-- 改变数据传输过来的显示效果 -->
                            </template>
                        </el-table-column>
...
<script>
//import axios from 'axios';/* 和下面的发生异步请求，获取数据是关联的 */
...
export default {
    ...
    mounted() {
        //发生异步请求，获取数据
        /*                  axios.get("http://yapi.smart-xwork.cn/mock/169327/emp/deleteById").then((result) => {
                            this.tableData = result.data.data;
                        });//这里服务器数据出问题的不用指望有数据返回 */
    },
}
</script>
